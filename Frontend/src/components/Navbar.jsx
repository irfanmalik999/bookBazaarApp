  ...
  return (
    <>
        <div className={`  max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white
             ${sticky ? " sticky-navbar shadow-md bg-base-200 dark:bg-slate-800 duration-100 transition-all ease-linear ":'' } `} >
                ...
                <div className="navbar-end space-x-3 ">
                    ...
                    <div className=" hidden md:block ">
                        <label className=" px-3 py-2 border rounded-md flex items-center gap-2">
                            <input type="text" className="grow outline-none dark:bg-slate-800  " placeholder="Search" />
                            <svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 16 16" fill="currentColor" className="h-4 w-4 opacity-70">
